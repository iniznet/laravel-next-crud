                ...
                <div className="p-6">
                    {aspectFields.map((aspect, index) => (
                        <div key={index} className="mb-4">
                            ...
                            <InputTextarea
                                ...
                                value={formData[aspect.field]}
                                onChange={(e) => handleInputChange(e, aspect.field)}
                            />
                        </div>
                    ))}
                    ...
                    <div className="mtext-sm text-red-700 mb-10 italic bg-red-100 p-4 rounded-lg">
                        ...
                        <div className="mb-2">
                            ...
                            <InputTextarea
                                ...
                                onChange={(e) => handleInputChange(e, 'risiko')}
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <InputTextarea
                                ...
                                onChange={(e) => handleInputChange(e, 'mitigasi')}
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center gap-6">
                        <Button
                            ...
                            icon="pi pi-trash"
                            onClick={handleClear}
                            className="p-button-outlined p-button-danger hover:bg-red-100 transition duration-300 px-8 py-3 text-lg rounded-full"
                        />
                        <Button
                            label="Simpan"
                            icon="pi pi-check"
                            onClick={handleSave}
                            className="p-button-raised p-button-success hover:bg-green-600 transition duration-300 px-10 py-3 text-lg rounded-full"
                        />
                    </div>
                </div>
            </div>
