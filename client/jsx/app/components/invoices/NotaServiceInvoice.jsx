...
const NotaServiceInvoice = ({ notaService, visible, onClose }) => {
    ...
    return (<Dialog visible={visible} style={{ width: '80vw' }} onHide={onClose} header="Service Order Preview">
            <TabView>
                <TabPanel header="A4 Service Order">
                    {pdfDataUrlA4 && (<iframe title="A4 Service Order" src={pdfDataUrlA4} width="100%" height="600px"/>)}
                </TabPanel>
                <TabPanel header="Thermal Service Order">
                    {pdfDataUrlThermal && (<iframe title="Thermal Service Order" src={pdfDataUrlThermal} width="100%" height="600px"/>)}
                </TabPanel>
            </TabView>
        </Dialog>);
};
