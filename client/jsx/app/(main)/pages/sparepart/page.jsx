            ...
            <div className="col-12">
                <div className="card">
                    ...
                    {loading ? (<DataTable value={Array.from({ length: 5 })} header={header}>
                        ...
                        </DataTable>) : (<DataTable ref={dt} value={stocks} selection={selectedStocks} onSelectionChange={(e) => setSelectedStocks(e.value)} dataKey="ID" paginator rows={10} rowsPerPageOptions={[5, 10, 25]} className="datatable-responsive" paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown" currentPageReportTemplate="Menampilkan {first} sampai {last} dari {totalRecords} spareparts" globalFilter={globalFilter} emptyMessage="Sparepart tidak ditemukan." header={header} responsiveLayout="scroll">
